window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function UsageTable({ rows, nameLabel, tokensLabel, requestsLabel, outputLabel, cachedLabel, shareLabel, pending, unknown, locale, colors }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dsh-um-table-shell",
				style: shellStyle,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dsh-um-desktop-table dsh-um-table-head",
						style: headStyle,
						children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dsh-um-desktop-table",
						style: bodyStyle,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dsh-um-mobile-rows",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "dsh-um-mobile-list-head",
							...
							className: "dsh-um-mobile-empty",
							children: pending
						}) : rows.map((row) => {
							const share = totalTokens <= 0 ? 0 : Math.min(100, row.tokens / totalTokens * 100);
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
								className: "dsh-um-mobile-row",
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: "dsh-um-mobile-row-head",
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: "dsh-um-mobile-row-name",
											...
											className: "dsh-um-mobile-row-value",
											children: formatCompactNumber(row.tokens, locale)
										})]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: "dsh-um-mobile-row-meta",
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
												formatCompactNumber(row.requests, locale),
												" ",
												requestsLabel
											] }),
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
												formatCompactNumber(row.outputTokens, locale),
												" ",
												outputLabel
											] }),
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										className: "dsh-um-mobile-row-progress",
