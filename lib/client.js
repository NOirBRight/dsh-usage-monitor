...
`;
		...
		function assertMinVersion(ctx) {
			const boot = globalThis.__DSH_BOOT__;
			if (boot?.graph && "@deepseek-ai/dsh-client-runtime" in boot.graph) throw new Error("dsh-usage-monitor >=0.2.4 requires DSH >=0.1.2-alpha.1; on DSH 0.1.1-rc.2 use github:NOirBRight/dsh-usage-monitor#v0.2.2");
			try {
				if (ctx.get?.("dsh-client-runtime") !== void 0) throw new Error("dsh-usage-monitor >=0.2.4 requires DSH >=0.1.2-alpha.1; on DSH 0.1.1-rc.2 use github:NOirBRight/dsh-usage-monitor#v0.2.2");
			} catch (e) {
